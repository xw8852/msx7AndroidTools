...
public class ImageFetcher extends ImageWorker {
    ...
    private static final int DEFAULT_IMAGE_HEIGHT = Math.min(1024, Math.max(0, Controller.HEIGHT));
    private static final int DEFAULT_IMAGE_WIDTH = Math.min(1024, Math.max(0, Controller.WIDTH));
