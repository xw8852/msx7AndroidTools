...
public class RoudShape extends Drawable implements Drawable.Callback {
     ...
     */
    public RoudShape(Drawable drawable, int orientation) {
        this(null, null);
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        int orientation = a.getInt(R.styleable.RoudShape_clipOrientation, HORIZONTAL);
        Drawable dr = a.getDrawable(R.styleable.RoudShape_drawable);
    ...
    public PointF testcal(Rect rect, double angle) {
        ...
        x +=  FloatMath.sin((float)changeAngleToUnit(angle)) * r;
        float y=rect.top+rect.height()/2.0f-FloatMath.cos((float)changeAngleToUnit(angle))*r;
        return new PointF((float) x, (float) y);
    }

    public double changeAngleToUnit(double angle){
